...
const Button: React.FC<ButtonProps> = ({
  ...
  const getVariantStyles = () => {
    switch (variant) {
      case "primary":
        return { gradient: ["#059669", "#047857"], textColor: "text-white" };
      case "secondary":
        return { gradient: ["#4B5563", "#374151"], textColor: "text-white" };
      case "danger":
        return { gradient: ["#EF4444", "#DC2626"], textColor: "text-white" };
      case "ghost":
        return {
